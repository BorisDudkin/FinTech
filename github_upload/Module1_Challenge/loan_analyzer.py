...
print(f"The present value of the selected loan: {present_value: .2f}")
...
def loan_present_value(future_value, remaining_months, annual_discount_rate):
    """This function is used to calculate the present value of the future cash flow

    Args:
        future_value (int): loan future value
        remaining_months (int): remaining time to maturity in months
        annual_discount_rate (float): discount rate
    """
...
present_value = loan_present_value(new_loan.get("future_value"), new_loan.get("remaining_months"), annual_discount_rate)
...
print(f"Loans priced below 500: {inexpensive_loans}")
